...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { currently: @education.currently, description: @education.description, finish: @education.finish, location: @education.location, start: @education.start, title: @education.title }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { currently: @education.currently, description: @education.description, finish: @education.finish, location: @education.location, start: @education.start, title: @education.title }
    assert_redirected_to education_path(assigns(:education))
  end
