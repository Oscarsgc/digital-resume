...
class ToolsControllerTest < ActionController::TestCase
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post :create, tool: { name: @tool.name, rating: @tool.rating, years_experience: @tool.years_experience }
    end
  ...
  test "should update tool" do
    patch :update, id: @tool, tool: { name: @tool.name, rating: @tool.rating, years_experience: @tool.years_experience }
    assert_redirected_to tool_path(assigns(:tool))
  end
